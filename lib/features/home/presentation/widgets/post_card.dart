...
import 'package:flutter_bog_app_with_clean_arch_bloc_blogger_api/features/post_view/presentation/screens/post_view_screen.dart';
    ...
    return InkWell(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => PostViewScreen(postEntity: postEntity),
          ),
        );
      },
      child: Container(
